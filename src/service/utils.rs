...
impl crate::server::MyService {
    ...
    pub async fn _colink_internal_storage_update(
        &self,
        user_id: &str,
        key_name: &str,
        payload: &[u8],
    ) -> Result<String, Status> {
        let key_name = format!("_colink_internal:{}", key_name);
    ...
    pub async fn _colink_internal_storage_read(
        &self,
        user_id: &str,
        key_name: &str,
    ) -> Result<Vec<u8>, Status> {
        let real_key_name = format!("_colink_internal:{}", key_name);
    ...
    pub async fn _colink_internal_storage_contains(
        &self,
        user_id: &str,
        key_name: &str,
    ) -> Result<bool, Status> {
